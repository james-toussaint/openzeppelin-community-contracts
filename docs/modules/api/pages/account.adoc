...
:RoleAccount: pass:normal[xref:account.adoc#RoleAccount[`RoleAccount`]]
:SignerAccessManaged: pass:normal[xref:utils/cryptography.adoc#SignerAccessManaged[`SignerAccessManaged`]]
:RoleAccountFactory: pass:normal[xref:account.adoc#RoleAccountFactory[`RoleAccountFactory`]]
:RoleAccount: pass:normal[xref:account.adoc#RoleAccount[`RoleAccount`]]
...
:RoleAccountDirectCallNotAllowed: pass:normal[xref:#RoleAccount-RoleAccountDirectCallNotAllowed--[`++RoleAccountDirectCallNotAllowed++`]]
:RoleAccountInvalidImmutableArgs: pass:normal[xref:#RoleAccount-RoleAccountInvalidImmutableArgs--[`++RoleAccountInvalidImmutableArgs++`]]
:constructor: pass:normal[xref:#RoleAccount-constructor--[`++constructor++`]]
:accessManager: pass:normal[xref:#RoleAccount-accessManager--[`++accessManager++`]]
:roleId: pass:normal[xref:#RoleAccount-roleId--[`++roleId++`]]
:_erc7821AuthorizedExecutor: pass:normal[xref:#RoleAccount-_erc7821AuthorizedExecutor-address-bytes32-bytes-[`++_erc7821AuthorizedExecutor++`]]
:receive: pass:normal[xref:#RoleAccount-receive--[`++receive++`]]

[.contract]
[[RoleAccount]]
=== `++RoleAccount++` link:https://github.com/OpenZeppelin/openzeppelin-community-contracts/blob/master/contracts/account/RoleAccount.sol[{github-icon},role=heading-link]
...
[.contract-item]
[[RoleAccount-constructor--]]
==== `[.contract-item-name]#++constructor++#++()++` [.item-kind]#public#

[.contract-item]
[[RoleAccount-accessManager--]]
==== `[.contract-item-name]#++accessManager++#++() → contract IAccessManager accessManager_++` [.item-kind]#public#
...
[.contract-item]
[[RoleAccount-roleId--]]
==== `[.contract-item-name]#++roleId++#++() → uint64 roleId_++` [.item-kind]#public#
...
[.contract-item]
[[RoleAccount-_erc7821AuthorizedExecutor-address-bytes32-bytes-]]
==== `[.contract-item-name]#++_erc7821AuthorizedExecutor++#++(address caller, bytes32 mode, bytes executionData) → bool++` [.item-kind]#internal#

See {ERC7821-_erc7821AuthorizedExecutor}. In addition to the default authorization (a
...
[.contract-item]
[[RoleAccount-RoleAccountDirectCallNotAllowed--]]
==== `[.contract-item-name]#++RoleAccountDirectCallNotAllowed++#++()++` [.item-kind]#error#

[.contract-item]
[[RoleAccount-RoleAccountInvalidImmutableArgs--]]
==== `[.contract-item-name]#++RoleAccountInvalidImmutableArgs++#++()++` [.item-kind]#error#

:RoleAccountDeployed: pass:normal[xref:#RoleAccountFactory-RoleAccountDeployed-address-uint64-address-[`++RoleAccountDeployed++`]]
:constructor: pass:normal[xref:#RoleAccountFactory-constructor--[`++constructor++`]]
:getRoleAccount: pass:normal[xref:#RoleAccountFactory-getRoleAccount-address-uint64-[`++getRoleAccount++`]]
:getImplementation: pass:normal[xref:#RoleAccountFactory-getImplementation--[`++getImplementation++`]]
:deployRoleAccount: pass:normal[xref:#RoleAccountFactory-deployRoleAccount-address-uint64-[`++deployRoleAccount++`]]
:_deployImplementation: pass:normal[xref:#RoleAccountFactory-_deployImplementation--[`++_deployImplementation++`]]

[.contract]
[[RoleAccountFactory]]
=== `++RoleAccountFactory++` link:https://github.com/OpenZeppelin/openzeppelin-community-contracts/blob/master/contracts/account/RoleAccountFactory.sol[{github-icon},role=heading-link]
...
[.contract-item]
[[RoleAccountFactory-constructor--]]
==== `[.contract-item-name]#++constructor++#++()++` [.item-kind]#public#

[.contract-item]
[[RoleAccountFactory-getRoleAccount-address-uint64-]]
==== `[.contract-item-name]#++getRoleAccount++#++(address accessManager, uint64 roleId) → address++` [.item-kind]#public#
...
[.contract-item]
[[RoleAccountFactory-getImplementation--]]
==== `[.contract-item-name]#++getImplementation++#++() → address++` [.item-kind]#public#

Returns the implementation used for deploying role accounts.

[.contract-item]
[[RoleAccountFactory-deployRoleAccount-address-uint64-]]
==== `[.contract-item-name]#++deployRoleAccount++#++(address accessManager, uint64 roleId) → address++` [.item-kind]#public#
...
[.contract-item]
[[RoleAccountFactory-_deployImplementation--]]
==== `[.contract-item-name]#++_deployImplementation++#++() → address++` [.item-kind]#internal#

Called once during construction to get the implementation used for deploying role accounts.
Can be overridden to provide a custom implementation.

[.contract-item]
[[RoleAccountFactory-RoleAccountDeployed-address-uint64-address-]]
==== `[.contract-item-name]#++RoleAccountDeployed++#++(address indexed accessManager, uint64 indexed roleId, address account)++` [.item-kind]#event#
