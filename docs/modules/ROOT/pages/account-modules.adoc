...
To support _different guardian types_, we can leverage ERC-7913 as discussed in the xref:contracts::multisig.adoc#beyond-standard-signature-verification[multisig] section. For ERC-7579 modules, this is implemented through the xref:api:account.adoc#ERC7579Multisig[`ERC7579Multisig`] validator.
