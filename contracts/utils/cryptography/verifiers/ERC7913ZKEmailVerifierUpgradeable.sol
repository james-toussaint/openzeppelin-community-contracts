 ...
 * ```
 */
contract ERC7913ZKEmailVerifierUpgradeable is Initializable, IERC7913SignatureVerifier {
    using ZKEmailUtils for EmailProof;

    function __ERC7913ZKEmailVerifier_init() internal onlyInitializing {
    }

    function __ERC7913ZKEmailVerifier_init_unchained() internal onlyInitializing {
    }
    /**
