...
import {ERC7579ExecutorUpgradeable} from "./ERC7579ExecutorUpgradeable.sol";
 ...
 */
abstract contract ERC7579SelectorExecutorUpgradeable is Initializable, ERC7579ExecutorUpgradeable {
    ...
    /// @custom:storage-location erc7201:openzeppelin.storage.ERC7579SelectorExecutor
    struct ERC7579SelectorExecutorStorage {
        /// @dev Mapping from account to set of authorized selectors
        mapping(address account => EnumerableSet.Bytes32Set) _authorizedSelectors;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC7579SelectorExecutor")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC7579SelectorExecutorStorageLocation = 0x84310db363b6b03c562ea45acff67118fca11df0a92249fbab450e4c3ef6fd00;

    function _getERC7579SelectorExecutorStorage() private pure returns (ERC7579SelectorExecutorStorage storage $) {
        assembly {
            $.slot := ERC7579SelectorExecutorStorageLocation
        }
    }

    function __ERC7579SelectorExecutor_init() internal onlyInitializing {
    }

    function __ERC7579SelectorExecutor_init_unchained() internal onlyInitializing {
    }
    ...
    function isAuthorized(address account, bytes4 selector) public view virtual returns (bool) {
        ERC7579SelectorExecutorStorage storage $ = _getERC7579SelectorExecutorStorage();
