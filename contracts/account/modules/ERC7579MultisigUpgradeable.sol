...
import {ERC7579ValidatorUpgradeable} from "./ERC7579ValidatorUpgradeable.sol";
 ...
 */
abstract contract ERC7579MultisigUpgradeable is Initializable, ERC7579ValidatorUpgradeable {
    ...
    /// @custom:storage-location erc7201:openzeppelin.storage.ERC7579Multisig
    struct ERC7579MultisigStorage {
        mapping(address account => EnumerableSet.BytesSet) _signersSetByAccount;
        mapping(address account => uint64) _thresholdByAccount;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC7579Multisig")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC7579MultisigStorageLocation = 0x1c68cf208b401da42450ff3f09bb5c7250b9f7ee9424bfdbffa5f7c7cf28ca00;

    function _getERC7579MultisigStorage() private pure returns (ERC7579MultisigStorage storage $) {
        assembly {
            $.slot := ERC7579MultisigStorageLocation
        }
    }

    function __ERC7579Multisig_init() internal onlyInitializing {
    }

    function __ERC7579Multisig_init_unchained() internal onlyInitializing {
    }
    /**
    ...
    function onUninstall(bytes calldata /* data */) public virtual {
        ERC7579MultisigStorage storage $ = _getERC7579MultisigStorage();
