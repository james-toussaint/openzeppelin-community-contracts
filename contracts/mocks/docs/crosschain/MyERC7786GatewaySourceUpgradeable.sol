...
abstract contract MyERC7786GatewaySourceUpgradeable is Initializable, IERC7786GatewaySource {
    error UnsupportedNativeTransfer();

    function __MyERC7786GatewaySource_init() internal onlyInitializing {
    }

    function __MyERC7786GatewaySource_init_unchained() internal onlyInitializing {
    }
