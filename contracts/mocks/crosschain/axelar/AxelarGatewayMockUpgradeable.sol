...
contract AxelarGatewayMockUpgradeable is Initializable {
    ...
    function __AxelarGatewayMock_init() internal onlyInitializing {
    }

    function __AxelarGatewayMock_init_unchained() internal onlyInitializing {
    }
