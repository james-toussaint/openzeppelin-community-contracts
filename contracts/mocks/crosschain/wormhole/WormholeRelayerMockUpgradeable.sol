...
contract WormholeRelayerMockUpgradeable is Initializable {
    uint16 internal _localChainId;
    uint64 private _seq;

    function __WormholeRelayerMock_init(uint16 localChainId) internal onlyInitializing {
        __WormholeRelayerMock_init_unchained(localChainId);
    }

    function __WormholeRelayerMock_init_unchained(uint16 localChainId) internal onlyInitializing {
