 ...
 */
abstract contract OnTokenTransferAdapterUpgradeable is Initializable, IERC1363Receiver {
    function __OnTokenTransferAdapter_init() internal onlyInitializing {
    }

    function __OnTokenTransferAdapter_init_unchained() internal onlyInitializing {
    }
