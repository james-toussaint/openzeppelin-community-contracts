 ...
 * {ERC20Forcible}: Shared base seam that lets extensions detect and stand down during a forced transfer, so {ERC20Seizable} composes with restriction-based extensions like {ERC20Freezable} and {ERC20Restricted} without extra wiring.
 ...
 * {ERC20Seizable}: Extension of ERC20 that lets an authorized account seize (force-transfer) tokens from an account, bypassing the checks of composed extensions that honor {ERC20Forcible} (e.g. {ERC20Freezable}, {ERC20Restricted}).
