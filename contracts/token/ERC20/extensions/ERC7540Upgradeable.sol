...
import {IERC7540, IERC7540Operator, IERC7540Deposit, IERC7540Redeem} from "@openzeppelin/community-contracts/contracts/interfaces/IERC7540.sol";
import {IERC7575, IERC7575Share} from "@openzeppelin/community-contracts/contracts/interfaces/IERC7575.sol";
 ...
 * ====
 */
abstract contract ERC7540Upgradeable is Initializable, ERC165Upgradeable, ERC20Upgradeable, IERC4626, IERC7540, IERC7575Share {
    using Math for uint256;

    /// @custom:storage-location erc7201:openzeppelin.storage.ERC7540
    struct ERC7540Storage {
        IERC20 _asset;
        uint8 _underlyingDecimals;

        mapping(address owner => mapping(address controller => bool)) _isOperator;
        uint256 _totalPendingDepositAssets;
        uint256 _totalPendingRedeemShares;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC7540")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC7540StorageLocation = 0x6a0262cf8369431c9cb496a61d9014582eec983295ac218bf25afb75576dc400;
     ...
     */
    function __ERC7540_init(IERC20 asset_) internal onlyInitializing {
        __ERC7540_init_unchained(asset_);
    }

    function __ERC7540_init_unchained(IERC20 asset_) internal onlyInitializing {
