 ...
 */
abstract contract ERC7540AdminDepositUpgradeable is Initializable, ERC7540Upgradeable {
    /**
    ...
    /// @custom:storage-location erc7201:openzeppelin.storage.ERC7540AdminDeposit
    struct ERC7540AdminDepositStorage {
        mapping(address controller => PendingDeposit) _deposits;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC7540AdminDeposit")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC7540AdminDepositStorageLocation = 0x448829ea60b5cd3040b631a042dbd9399fe60e82ebeb88acf88f3f711d17ee00;

    function _getERC7540AdminDepositStorage() private pure returns (ERC7540AdminDepositStorage storage $) {
        assembly {
            $.slot := ERC7540AdminDepositStorageLocation
        }
    }
    ...
    function __ERC7540AdminDeposit_init() internal onlyInitializing {
    }

    function __ERC7540AdminDeposit_init_unchained() internal onlyInitializing {
    }
    ...
    function _requestDeposit(
        ...
        ERC7540AdminDepositStorage storage $ = _getERC7540AdminDepositStorage();
