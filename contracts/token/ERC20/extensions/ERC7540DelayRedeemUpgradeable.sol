 ...
 */
abstract contract ERC7540DelayRedeemUpgradeable is Initializable, ERC7540Upgradeable, IERC6372 {
    using SafeCast for uint256;
    using Checkpoints for Checkpoints.Trace208;

    /// @custom:storage-location erc7201:openzeppelin.storage.ERC7540DelayRedeem
    struct ERC7540DelayRedeemStorage {
        mapping(address controller => Checkpoints.Trace208) _redeems;
        mapping(address controller => uint256) _claimedRedeems;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC7540DelayRedeem")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC7540DelayRedeemStorageLocation = 0x0b231ea49755fb5735801851aeb1fa5ff99929906b21ae9f6daf198a9dab0c00;

    function _getERC7540DelayRedeemStorage() private pure returns (ERC7540DelayRedeemStorage storage $) {
        assembly {
            $.slot := ERC7540DelayRedeemStorageLocation
        }
    }
    ...
    function __ERC7540DelayRedeem_init() internal onlyInitializing {
        __ERC7540DelayRedeem_init_unchained();
    }

    function __ERC7540DelayRedeem_init_unchained() internal onlyInitializing {
    ...
    function _requestRedeem(
        ...
        ERC7540DelayRedeemStorage storage $ = _getERC7540DelayRedeemStorage();
